...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
		...
		Mage::getConfig()->saveConfig('design/package/name', 'ma_sozo', $scope, $store);
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_sozo1', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_sozo1_home', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_sozo1', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_sozo1_home', 'default', 0);
