...
class Redstage_PreviewProduct_Model_Product_Type
{
    /**
    ...
    const DEFAULT_TYPE_MODEL    = 'previewproduct/product_type_simple';
    const DEFAULT_PRICE_MODEL   = 'previewproduct/product_type_price';
    ...
    public static function factory($product, $singleton = false)
    {
        ...
        list($moduleName, $typeInstanceName) = explode("/", $typeModelName);
        
        if ($moduleName == "bundle") {
                $typeModelName = "previewproduct/product_type_bundle";
        } else {
            $typeModelName = "previewproduct/" . $typeInstanceName;
        }
